...
public class AiAgent : MonoBehaviour
{
    ...
    public bool clickToSwapStateToStateInDropdown = false;
    ...
    void Update()
    {
        ...
        if (clickToSwapStateToStateInDropdown)
        {
            clickToSwapStateToStateInDropdown = false;
            stateMachine.ChangeState(initialState);
        }
    ...
    ***************************************************************************************************************************************/
    ...
    {
        // enable ActivateToEnableBotNetworkCalls in hierarchy to enable network calls
