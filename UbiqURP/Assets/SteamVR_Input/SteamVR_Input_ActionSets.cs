...
namespace Valve.VR
{
    ...
    public partial class SteamVR_Actions
    {
        ...
        private static SteamVR_Input_ActionSet_ultimatexr p_ultimatexr;
        ...
        public static SteamVR_Input_ActionSet_ultimatexr ultimatexr
        {
            get
            {
                return SteamVR_Actions.p_ultimatexr.GetCopy<SteamVR_Input_ActionSet_ultimatexr>();
            }
        }
        ...
        private static void StartPreInitActionSets()
        {
            ...
            SteamVR_Actions.p_ultimatexr = ((SteamVR_Input_ActionSet_ultimatexr)(SteamVR_ActionSet.Create<SteamVR_Input_ActionSet_ultimatexr>("/actions/ultimatexr")));
            Valve.VR.SteamVR_Input.actionSets = new Valve.VR.SteamVR_ActionSet[] {
                    SteamVR_Actions._default,
                    SteamVR_Actions.platformer,
                    SteamVR_Actions.buggy,
                    SteamVR_Actions.mixedreality,
                    SteamVR_Actions.ultimatexr};
        }
    }
}
